...
def build_app() -> Application:
    ...
    # ── Battle 1v1 ───────────────────────────────────────────────
    # /attack — reply pesan lawan atau pakai user ID
    # /battlelog — riwayat battle 1v1 (ganti dari /war supaya tidak konflik)
    app.add_handler(CommandHandler("attack",      battle_handlers.attack))
    app.add_handler(CommandHandler("defend",      battle_handlers.defend))
    app.add_handler(CommandHandler("battlelog",   battle_handlers.war_history))
    ...
    # ── War Declaration (antar 2 kerajaan + voting) ──────────────
    app.add_handler(CommandHandler("war",         war_handlers.war))

    # ── Alliance ─────────────────────────────────────────────────
    app.add_handler(CommandHandler("alliance",    alliance_handlers.alliance))

    # ── Kingdom War (antar banyak kerajaan) ──────────────────────
    ...
    app.add_handler(CallbackQueryHandler(alliance_handlers.alliance_callback,    pattern="^al_"))
    app.add_handler(CallbackQueryHandler(war_handlers.war_callback,              pattern="^war_"))
